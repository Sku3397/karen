    ...
    def __init__(self, llm_client=None):
        ...
        self.intent_patterns = {
            ...
            Intent.APPOINTMENT_CANCEL: [
                ...
                r'\bneed to cancel\b',
                r'\b(cancel|delete).*booking\b',
                r'\bwon\'t be (home|here)\b',
                r'\bplease cancel\b'
            ],
            ...
            Intent.SERVICE_INQUIRY: [
                ...
                r'\bdo you (do|install|fix|repair)\b'
            ],
            Intent.COMPLAINT: [
                r'\b(unhappy|dissatisfied|problem with|complaint)\b',
                r'\b(not (working|fixed|done right|satisfied))\b',
                r'\b(terrible|awful|worst)\b',
                r'\bwasn\'t done (correctly|right)\b',
                r'\b(wrong|bad) (job|work|service)\b',
                r'\bdone wrong\b'
            ],
            Intent.COMPLIMENT: [
