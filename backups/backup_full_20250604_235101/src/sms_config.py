...
class SMSConfig:
    ...
    def _load_configuration(self):
        ...
        self.service_configs = {
            ...
            ServiceType.QUOTE_REQUEST: ServiceConfig(
                ...
                keywords=["quote", "estimate", "price", "cost", "how much", "pricing"],
                default_priority=MessagePriority.NORMAL,
                response_time=ResponseTimeType.STANDARD,
            ...
            ServiceType.SCHEDULING: ServiceConfig(
                ...
                keywords=["schedule", "appointment", "book", "available", "when", "time"],
                default_priority=MessagePriority.NORMAL,
                response_time=ResponseTimeType.STANDARD,
    ...
    def classify_service_type(self, message_content: str) -> ServiceType:
        ...
        for service_config in self.service_configs.values():
            if service_config.emergency_keywords:
                for keyword in service_config.emergency_keywords:
        ...
        if keyword_scores:
            # Return service type with highest keyword match score
